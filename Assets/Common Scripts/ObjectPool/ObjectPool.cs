...
public sealed class ObjectPool : MonoBehaviour
{
	...
	public class CategoryData
	{
		...
		public List<StartupPool> dataList;
	}
	...
	public static void CreatePool(GameObject prefab, int initialPoolSize)
	{
		if (prefab != null)
		{
			if(!instance.nameToPrefabs.ContainsKey(prefab.name)) 
			{
				instance.nameToPrefabs.Add(prefab.name, prefab);
			}
	...
	{
		if(instance.nameToPrefabs.ContainsKey(name))
			return instance.nameToPrefabs[name];
